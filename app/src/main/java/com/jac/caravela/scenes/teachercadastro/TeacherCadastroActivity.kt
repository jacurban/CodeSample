...
class TeacherCadastroActivity : AppCompatActivity(), TeacherCadastro.View {

    private lateinit var presenter: TeacherCadastro.Presenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = TeacherCadastroPresenter(this)

        userInfo = intent.getParcelableExtra(EXTRA_TEACHER_EDIT)
    ...
    private fun setupToolbar() {
        ...
        toolbar_title?.text = getString(R.string.novo_professor)
    }
    ...
    companion object {
        const val EXTRA_TEACHER_EDIT = "EXTRA_TEACHER_EDIT"
