...
class ParentCadastroActivity : AppCompatActivity(), ParentCadastro.View {

    private lateinit var presenter: ParentCadastro.Presenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = ParentCadastroPresenter(this)
        userInfo = intent.getParcelableExtra(EXTRA_PARENT_EDIT)
    ...
    private fun setupToolbar() {
        ...
        toolbar_title?.text = getString(R.string.novo_responsavel)
    }
    ...
    companion object {
        const val EXTRA_PARENT_EDIT = "EXTRA_PARENT_EDIT"
